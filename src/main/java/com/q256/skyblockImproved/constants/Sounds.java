...
public class Sounds {
    public static final ArrayList<String> ALL_SOUNDS = new ArrayList<>(Arrays.asList(
            //--------------------------------------------------General
            "ambient.cave.cave",
    ...
    public static final String[] NO_DUPE_SOUNDS = {
            //General
            "ambient.cave.cave",
            "ambient.weather.rain",
            "ambient.weather.thunder",
    ...
    //Sounds from: https://www.minecraftforum.net/forums/mapping-and-modding-java-edition/mapping-and-modding-tutorials/2213619-1-8-all-playsound-sound-arguments
}
